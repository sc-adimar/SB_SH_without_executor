...
//		Bson filter = Filters.and(Filters.and(Filters.gte("startDate",startDate ), Filters.lte("endDate",endDate)),Filters.eq("hallName",hallName));
	...
	@PostMapping("/bookmultiplewiththread/")
	private static void bookmultiplewwoexecutor() throws ParseException, FileNotFoundException {
...
//	 			jsonObject
			...
			int batchsize_of_thread = 10;
	 		...
	 		System.out.println("length :"+det.length);
